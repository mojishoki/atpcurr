%theorem: mul(neg(neg(8,1),1),9) = 54
...
cnf(myformula, negated_conjecture, mul(neg(neg(s(s(s(s(s(s(s(s(o)))))))),s(o)),s(o)),s(s(s(s(s(s(s(s(s(o)))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))))))))))))).