...
cnf(myformula, negated_conjecture, neg(mul(neg(s(s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(s(o))))))),s(s(s(o)))) != s(s(s(s(s(s(s(s(s(o)))))))))).