%theorem: plus(mul(plus(4,6),2),7) = 27
...
cnf(myformula, negated_conjecture, plus(mul(plus(s(s(s(s(o)))),s(s(s(s(s(s(o))))))),s(s(o))),s(s(s(s(s(s(s(o)))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))).