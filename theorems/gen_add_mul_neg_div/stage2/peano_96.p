%theorem: plus(div(plus(2,8),1),7) = 17
...
cnf(myformula, negated_conjecture, plus(div(plus(s(s(o)),s(s(s(s(s(s(s(s(o))))))))),s(o)),s(s(s(s(s(s(s(o)))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))).