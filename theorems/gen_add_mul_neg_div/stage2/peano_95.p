%theorem: mul(neg(plus(8,5),9),7) = 28
...
cnf(myformula, negated_conjecture, mul(neg(plus(s(s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(o)))))),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(s(s(s(s(s(o)))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))).