%theorem: plus(plus(plus(8,7),8),1) = 24
...
cnf(myformula, negated_conjecture, plus(plus(plus(s(s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(s(s(s(o))))))))),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))).