%theorem: plus(div(mul(5,9),5),6) = 15
...
cnf(myformula, negated_conjecture, plus(div(mul(s(s(s(s(s(o))))),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(s(s(s(o)))))),s(s(s(s(s(s(o))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))).