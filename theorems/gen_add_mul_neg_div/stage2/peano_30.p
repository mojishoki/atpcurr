%theorem: mul(plus(neg(6,5),3),5) = 20
...
cnf(myformula, negated_conjecture, mul(plus(neg(s(s(s(s(s(s(o)))))),s(s(s(s(s(o)))))),s(s(s(o)))),s(s(s(s(s(o)))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))).