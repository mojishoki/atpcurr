%theorem: neg(mul(div(7,1),6),1) = 41
...
cnf(myformula, negated_conjecture, neg(mul(div(s(s(s(s(s(s(s(o))))))),s(o)),s(s(s(s(s(s(o))))))),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))))))))).