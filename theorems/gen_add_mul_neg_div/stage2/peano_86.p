%theorem: plus(neg(mul(6,4),5),1) = 20
...
cnf(myformula, negated_conjecture, plus(neg(mul(s(s(s(s(s(s(o)))))),s(s(s(s(o))))),s(s(s(s(s(o)))))),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))).