%theorem: mul(mul(div(6,2),6),3) = 54
...
cnf(myformula, negated_conjecture, mul(mul(div(s(s(s(s(s(s(o)))))),s(s(o))),s(s(s(s(s(s(o))))))),s(s(s(o)))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))))))))))))).