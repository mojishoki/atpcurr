%theorem: mul(neg(mul(1,7),4),8) = 24
...
cnf(myformula, negated_conjecture, mul(neg(mul(s(o),s(s(s(s(s(s(s(o)))))))),s(s(s(s(o))))),s(s(s(s(s(s(s(s(o))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))).