%theorem: plus(mul(div(7,1),4),4) = 32
...
cnf(myformula, negated_conjecture, plus(mul(div(s(s(s(s(s(s(s(o))))))),s(o)),s(s(s(s(o))))),s(s(s(s(o))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))).