%theorem: neg(mul(neg(9,6),6),4) = 14
...
cnf(myformula, negated_conjecture, neg(mul(neg(s(s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(s(s(o))))))),s(s(s(s(s(s(o))))))),s(s(s(s(o))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))).