%theorem: div(neg(mul(9,5),8),1) = 37
...
cnf(myformula, negated_conjecture, div(neg(mul(s(s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(s(o)))))),s(s(s(s(s(s(s(s(o))))))))),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))))).