%theorem: div(plus(mul(9,4),2),2) = 19
...
cnf(myformula, negated_conjecture, div(plus(mul(s(s(s(s(s(s(s(s(s(o))))))))),s(s(s(s(o))))),s(s(o))),s(s(o))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))).