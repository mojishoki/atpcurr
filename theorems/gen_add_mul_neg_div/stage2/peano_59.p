%theorem: plus(mul(mul(5,1),7),9) = 44
...
cnf(myformula, negated_conjecture, plus(mul(mul(s(s(s(s(s(o))))),s(o)),s(s(s(s(s(s(s(o)))))))),s(s(s(s(s(s(s(s(s(o)))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))))))))))))))))))))))))))))))).