%theorem: plus(neg(mul(2,9),4),5) = 19
...
cnf(myformula, negated_conjecture, plus(neg(mul(s(s(o)),s(s(s(s(s(s(s(s(s(o)))))))))),s(s(s(s(o))))),s(s(s(s(s(o)))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))).