%theorem: plus(mul(neg(9,0),8),1) = 73
...
cnf(myformula, negated_conjecture, plus(mul(neg(s(s(s(s(s(s(s(s(s(o))))))))),o),s(s(s(s(s(s(s(s(o))))))))),s(o)) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))).