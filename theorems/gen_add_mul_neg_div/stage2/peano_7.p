%theorem: plus(neg(plus(3,7),2),8) = 16
...
cnf(myformula, negated_conjecture, plus(neg(plus(s(s(s(o))),s(s(s(s(s(s(s(o)))))))),s(s(o))),s(s(s(s(s(s(s(s(o))))))))) != s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(s(o))))))))))))))))).