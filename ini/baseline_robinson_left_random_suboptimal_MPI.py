...
base_config = Munch(actions_added=False,
                    ...
                    outdir="results/baseline_robinson_left_random_suboptimal",
                    proof_allowed=True,
                    proof_dir="noproof",
...
def spec():
  return flop_simple_handle_experiment(experiment_name = 'baseline_robinson_left_random_suboptimal',
